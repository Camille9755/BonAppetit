<template>
  <div class="shop-info" ref="YScroll">
    <div class="info-content">
      ...
      <section class="section" >
        ...
        <div class="pic-wrapper" ref="XScroll">
...
<script>
    ...
    export default {
      ...
      methods:{
        _setScroll(){
          const ulWrapper = this.$refs.picsUl
          const liWidth = 120
          const space = 6
          const count = this.info.pics.length
          ulWrapper.style.width = ((liWidth+space)*count-space)+'px'
          this.yScroll = new BScroll(this.$refs.YScroll,{
            click:true
          })
          this.xScroll = new BScroll(this.$refs.XScroll,{
            click:true,
            scrollX: true
          })
        }
